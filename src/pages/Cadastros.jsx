...
const PLANOS_AVANCADOS = ["Essencial", "Financeiro", "Profissional"];

function LockedTab({ label }) {
  return (
    <div className="flex flex-col items-center justify-center py-20 gap-3 text-muted-foreground">
      <Lock className="w-8 h-8 opacity-40" />
      <p className="text-sm">A aba <strong>{label}</strong> está disponível nos planos Essencial, Financeiro e Profissional.</p>
    </div>
  );
}
