...
export default function Studio() {
  ...
  return (
    <div className="p-8 max-w-7xl mx-auto w-full min-h-[calc(100vh-4rem)] text-zinc-100">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div className="lg:col-span-1 space-y-4">
          ...
          {projects.map(project => (
            <motion.div 
              ...
              key={project.id} 
              className="p-4 rounded-2xl bg-zinc-900/40 border border-zinc-800 hover:border-[#c30147]/40 transition-all cursor-pointer group shadow-sm"
            >
        ...
        <div className="lg:col-span-3">
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="bg-zinc-900/30 border border-zinc-800/60 rounded-3xl overflow-hidden shadow-lg">
            <div className="p-6 border-b border-zinc-800 flex justify-between items-center bg-zinc-900/50">
              <h3 className="font-bold text-lg text-zinc-100">Tarefas do Projeto</h3>
            ...
            <div className="p-4 border-t border-zinc-800/50 bg-zinc-900/30 text-center">
